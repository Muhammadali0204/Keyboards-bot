            ...
            try:
                ...
                await msg.answer(
                    (
                        ...
                        "❗️Hozirda tugma holati faol emas, faollashtirish uchun "
                        "<code>♻️Tugmalar statusini o'zgartirish</code> "
                        "bo'limiga o'ting !</b>"
                    ),
            ...
            try:
                ...
                await msg.answer(
                    (
                        ...
                        "❗️Hozirda tugma holati faol emas, faollashtirish uchun <code>"
                        "♻️Tugmalarni tahrirlash</code> bo'limiga o'ting !</b>"
                    ),
