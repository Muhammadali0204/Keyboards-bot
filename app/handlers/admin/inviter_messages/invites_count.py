...
from app.utils.filters import AdminInviteFilter
from app.utils.enums import MEDALS, InviteStatus
from app.models.models import User, InviterButton, Invite
...
@router.message(
    F.text.replace("🟢", "").replace("🔴", "").strip() == "Reyting 🏆", AdminInviteFilter()
)
async def rating(msg: Message):
    await msg.answer("Natija ustida ishlanmoqda... iltimos kuting ...")
