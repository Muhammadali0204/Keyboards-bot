...
from app.models.models import Button, MessageButton
...
async def get_msg(msg: Message, state: FSMContext):
    ...
    if msg.content_type == MessageType.TEXT:
        ...
        await MessageButton.create(
            message_type=msg.content_type,
            message={"photo": msg.photo[-1].file_id, "caption": msg.html_text},
            parent_button=parent,
        ...
        await MessageButton.create(
            message_type=msg.content_type,
            message={"video": msg.video.file_id, "caption": msg.html_text},
            parent_button=parent,
            media_group_id=msg.media_group_id,
        )
        ...
        await MessageButton.create(
            message_type=msg.content_type,
            message={"animation": msg.animation.file_id, "caption": msg.html_text},
            parent_button=parent,
            media_group_id=msg.media_group_id,
        )
        ...
        await MessageButton.create(
            message_type=msg.content_type,
            message={"audio": msg.audio.file_id, "caption": msg.html_text},
            parent_button=parent,
            media_group_id=msg.media_group_id,
        )
        ...
        await MessageButton.create(
            message_type=msg.content_type,
            message={"sticker": msg.sticker.file_id, "caption": msg.html_text},
            parent_button=parent,
        )
        ...
        await msg.answer("<b>Ushbu xabar turi qo'llab quvvatlanmaydi 🙁</b>")
        await state.set_state(state=None)
        return
